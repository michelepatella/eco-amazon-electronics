...
DATA_PROCESSED_AR23_IM_G25F_DIR = f"{DATA_PROCESSED_AR23_IM_DIR}/gemini_2_5_flash"
...
DATA_PROCESSED_AR23_IM_G25F_ELEC_PATH = f"{DATA_PROCESSED_AR23_IM_G25F_DIR}/electronics.jsonl"
DATA_PROCESSED_AR23_IM_O3M_ELEC_PATH = f"{DATA_PROCESSED_AR23_IM_O3M_DIR}/electronics.jsonl"
DATA_PROCESSED_AR23_UR_ELEC_FULL_PATH = f"{DATA_PROCESSED_AR23_UR_ELEC_DIR}/electronics.inter"
DATA_PROCESSED_AR23_UR_ELEC_TRAIN_PATH = f"{DATA_PROCESSED_AR23_UR_ELEC_DIR}/electronics.train.inter"
DATA_PROCESSED_AR23_UR_ELEC_TEST_PATH = f"{DATA_PROCESSED_AR23_UR_ELEC_DIR}/electronics.test.inter"
DATA_PROCESSED_AR23_UR_ELEC_VALID_PATH = f"{DATA_PROCESSED_AR23_UR_ELEC_DIR}/electronics.valid.inter"
DATA_PROCESSED_GT_G25F_ELEC_PATH = f"{DATA_PROCESSED_GT_G25F_DIR}/electronics.jsonl"
DATA_PROCESSED_GT_O3M_ELEC_PATH = f"{DATA_PROCESSED_GT_O3M_DIR}/electronics.jsonl"
...
MODELS_LIGHTGCN_PREDS_G25F_DIR = f"{MODELS_LIGHTGCN_PREDS_DIR}/gemini_2_5_flash"
...
MODELS_LIGHTGCN_PREDS_G25F_SUS_PATH = f"{MODELS_LIGHTGCN_PREDS_G25F_DIR}/alpha_0_25.pth"
MODELS_LIGHTGCN_PREDS_G25F_BAL_PATH = f"{MODELS_LIGHTGCN_PREDS_G25F_DIR}/alpha_0_5.pth"
MODELS_LIGHTGCN_PREDS_G25F_REL_PATH = f"{MODELS_LIGHTGCN_PREDS_G25F_DIR}/alpha_0_75.pth"
MODELS_LIGHTGCN_PREDS_G25F_PURE_PATH = f"{MODELS_LIGHTGCN_PREDS_G25F_DIR}/alpha_1_0.pth"
MODELS_LIGHTGCN_PREDS_O3M_SUS_PATH = f"{MODELS_LIGHTGCN_PREDS_O3M_DIR}/alpha_0_25.pth"
MODELS_LIGHTGCN_PREDS_O3M_BAL_PATH = f"{MODELS_LIGHTGCN_PREDS_O3M_DIR}/alpha_0_5.pth"
MODELS_LIGHTGCN_PREDS_O3M_REL_PATH = f"{MODELS_LIGHTGCN_PREDS_O3M_DIR}/alpha_0_75.pth"
MODELS_LIGHTGCN_PREDS_O3M_PURE_PATH = f"{MODELS_LIGHTGCN_PREDS_O3M_DIR}/alpha_1_0.pth"

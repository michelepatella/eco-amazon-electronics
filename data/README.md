...
| `amazon_reviews_23/user_reviews/electronics/electronics.valid.inter` | TSV | Generated | 444 KB | 35,117 | `user_id:token`, `item_id:token`, `rating:float` | Validation split in RecBole format |
| `amazon_reviews_23/user_reviews/electronics/electronics.test.inter` | TSV | Generated | 841 KB | 65,863 | `user_id:token`, `item_id:token`, `rating:float` | Test split in RecBole format |

...
| Name | Format | Source | Size | Rows | Schema | Description |
|------|--------|--------|------|------|--------|-------------|
| `amazon_reviews_23/item_metadata/google_genai:gemini-2.5-flash/electronics.jsonl` | JSONL | Gemini 2.5 Flash enrichment | 52 MB | 9,710 | `main_category`, `title`, `average_rating`, `rating_number`, `features`, `description`, `price`, `images`, `videos`, `store`, `categories`, `details`, `parent_asin`, `bought_together`, `co2e_kg` | Item metadata enriched with PCF estimates via Gemini 2.5 Flash |

...
| `amazon_reviews_23/user_reviews/electronics/electronics.train.inter` | TSV | Generated | 4.5 MB | 363,028 | `user_id:token`, `item_id:token`, `rating:float` | Training split in RecBole format |
| `amazon_reviews_23/user_reviews/electronics/electronics.valid.inter` | TSV | Generated | 445 KB | 35,166 | `user_id:token`, `item_id:token`, `rating:float` | Validation split in RecBole format |
| `amazon_reviews_23/user_reviews/electronics/electronics.test.inter` | TSV | Generated | 846 KB | 66,270 | `user_id:token`, `item_id:token`, `rating:float` | Test split in RecBole format |
